# Generated by Django 5.1.6 on 2025-03-08 08:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('level', models.SmallIntegerField(choices=[(1, '1级'), (2, '2级'), (3, '3级'), (4, '4级')], default=1, verbose_name='号码等级')),
                ('status', models.SmallIntegerField(choices=[(1, '未分配'), (2, '已分配')], default=2, verbose_name='号码状态')),
